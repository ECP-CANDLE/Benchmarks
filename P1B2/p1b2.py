...
def load_data(shuffle=True, n_cols=None):
    train_path = get_file('P1B2.train.csv', origin='http://bioseed.mcs.anl.gov/~fangfang/benchmarks/data/P1B2.train.csv')
    test_path = get_file('P1B2.test.csv', origin='http://bioseed.mcs.anl.gov/~fangfang/benchmarks/data/P1B2.test.csv')
