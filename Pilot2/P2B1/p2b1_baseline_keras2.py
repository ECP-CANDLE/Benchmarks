...
class MyCallBack(keras.callbacks.Callback):
  def __init__(self, gParameters):
    ...
    self.epoch_time = 0
    self.train_time = 0
    self.batch_log = True #gParameters['batch_log']
...
# ####### Define Molecular Model, Solver and Compile #########
    ...
    my_hook = MyCallBack(GP)
    callbacks = [history, history_logger, candleRemoteMonitor, timeoutMonitor, my_hook]
    # loss = 0.
