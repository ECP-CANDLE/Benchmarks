...
def parse_args():
    ...
    parser.add_argument(
        "-d", "--latent_dim", type=int, default=10, help="latent dimensions"
    )
    parser.add_argument(
        "-m", "--model", default="cvae", help="generator model to use: ae, vae, cvae"
    )
    parser.add_argument(
        "-e", "--epochs", type=int, default=20, help="number of epochs to train"
    )
    parser.add_argument(
        "-b", "--batch_size", type=int, default=128, help="mini batch size"
    )
    parser.add_argument(
        "-k",
        "--top_k_types",
    ...
    parser.add_argument("--seed", type=int, default=2021, help="random seed state")
