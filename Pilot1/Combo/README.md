...
![Combo model architecture](https://raw.githubusercontent.com/ECP-CANDLE/Benchmarks/frameworks/Pilot1/Combo/figs/network.png "Combo model network architecture"){:height="50%" width="50%"}
