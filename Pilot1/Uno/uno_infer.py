...
def get_parser():
    ...
    parser.add_argument(
        "--model_file", required=True, help="json model description file"
    )
    ...
    parser.add_argument(
        ...
        help="partition of test dataset",
    )
    parser.add_argument(
        "-n", "--n_pred", type=int, default=1, help="the number of predictions to make"
    )

    parser.add_argument(
        "--single", default=False, help="do not use drug pair representation"
    )
    parser.add_argument(
        "--agg_dose",
        default=None,
