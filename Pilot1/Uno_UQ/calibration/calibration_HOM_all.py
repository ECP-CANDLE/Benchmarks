...
def main():
    ...
    if ( len ( sys.argv ) < 3 ) :
        ...
        sys.stderr.write ("FILENAME: usually <model>.predicted_INFER.tsv\n")
        sys.exit ( 0 )
    ...
    Ytest, Ypred_mean, yerror, sigma, Ypred_std, pred_name = candle.compute_statistics_homoscedastic_all(df_data)
