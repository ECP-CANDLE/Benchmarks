...
#
#
# This example will run 48 ranks per node, each rank is binded to a different GPU tile - 12 tiles on a node total
#
#
...
#conda activate /lus/gila/projects/candle_aesp_CNDA/avasan/envs/conda_2023_08_15_002_use
...
#./set_ze_mask_multiinstance.sh \
#python smiles_regress_transformer_run_large.py > output.log
